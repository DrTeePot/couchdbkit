...
class CouchdbkitHandler(object):
    ...
    __shared_state__ = dict(
            _databases = {},
            app_schema = collections.OrderedDict()
    )
    ...
    def register_schema(self, app_label, *schema):
        ...
        for s in schema:
            ...
            schema_dict = self.app_schema.setdefault(app_label, collections.OrderedDict())
    ...
    def get_schema(self, app_label, schema_name):
        ...
        return self.app_schema.get(app_label, collections.OrderedDict()).get(schema_name.lower())
